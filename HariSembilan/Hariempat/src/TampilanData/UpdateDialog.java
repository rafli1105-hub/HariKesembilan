...
public class UpdateDialog extends javax.swing.JDialog {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if (rs.next() && rs.getInt(1) > 0 && !newId.equals(oldIdKaryawan)) {
                JOptionPane.showMessageDialog(this, "ID baru sudah ada!");
                conn.close();
                return;
            }
            String sql = "UPDATE Karyawan SET idkaryawan = ?, Nama = ?, Alamat = ?, Gender = ?, Shift = ? WHERE IDKaryawan = ?";
            ...
            pst.setString(5, shift.getText().trim());
            pst.setString(6, oldIdKaryawan);
